...
module Admins
  ...
  describe 'surveys for' do
    ...
    it 'returns the managed services when is super admin' do
      admin = double 'admin', is_super_admin?: true, is_public_servant?: false
    ...
    it 'returns the managed surveys when is service admin' do
      ...
      admin = double 'admin', is_service_admin?: true, id: 'admin-id', is_super_admin?: false, service_surveys: service_surveys, is_public_servant?: false
